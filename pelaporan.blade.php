  ...
  <head>
    ...
    <style>
      ...
      .sidebar {
        ...
        z-index: 100; 
        box-shadow: 4px 0 20px rgba(2,132,199,.2);
      }
    ...
    <div class="main">
      ...
      <div id="sectionRekap">
        <div class="d-flex align-items-start justify-content-between flex-wrap gap-3 mb-4">
          <div>
            <div class="page-title">
              <i class="bi bi-bar-chart"></i> Rekap Harian
            </div>
          ...
          <div class="d-flex align-items-center gap-2 flex-wrap filter-bar">
            ...
            <button class="btn btn-primary fw-bold" onclick="applyFilterRekap()">
              <i class="bi bi-search"></i> Tampilkan
            </button>
            <button class="btn btn-print fw-bold" style="background: #8b5cf6; color: #fff; border: none;" onclick="window.print()">
              <i class="bi bi-printer"></i> Cetak
            </button>
            <button class="btn btn-success fw-bold" onclick="exportCSV()">
        ...
        <div class="row g-3 mb-4">
          <div class="col-md-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 d-flex flex-row align-items-center gap-3">
              ...
              <div>
                <div class="stat-num" id="r-statMasuk">0</div>
          ...
          <div class="col-md-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 d-flex flex-row align-items-center gap-3">
              ...
              <div>
                <div class="stat-num" id="r-statKeluar">0</div>
          ...
          <div class="col-md-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 d-flex flex-row align-items-center gap-3">
              <div class="stat-icon pindah">
                <i class="bi bi-arrow-left-right"></i>
              </div>
              <div>
                <div class="stat-num" id="r-statPindah">0</div>
                <div class="stat-label">Pindah Ruang</div>
              </div>
            </div>
          </div>
          <div class="col-md-3">
            <div class="card border-0 shadow-sm rounded-4 p-3 d-flex flex-row align-items-center gap-3">
              ...
              <div>
                <div class="stat-num" id="r-statTotal">0</div>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
          <h6 class="fw-bold mb-3">
            <i class="bi bi-table" style="margin-right: 8px; color: var(--primary);"></i>Rekap Per Ruang / Bangsal
          </h6>
      ...
      <div id="sectionSpm" style="display: none;">
        <div class="d-flex align-items-start justify-content-between mb-4">
          <div>
            <div class="page-title">
              <i class="bi bi-hospital"></i> Indikator SPM Rawat Inap
            </div>
            <div class="page-subtitle" id="pageDate4"></div>
          </div>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
          <div class="row g-3 align-items-end">
            ...
            <div class="col-auto d-flex gap-2">
              <button class="btn btn-primary fw-bold" onclick="hitungSPM()">
                <i class="bi bi-calculator"></i> Hitung Indikator
              </button>
              <button class="btn fw-bold btn-print" style="background: #8b5cf6; color: #fff; border: none;" onclick="window.print()">
                <i class="bi bi-printer"></i> Cetak
              </button>
            </div>
          </div>
        ...
        <div class="alert alert-info border-start border-primary border-4 rounded-3 mb-4" style="background: linear-gradient(135deg, #eff6ff, #e0f2fe);">
          <div class="fw-bold text-primary mb-1">
            <i class="bi bi-info-circle"></i> Catatan Perhitungan
          </div>
        ...
        <div class="spm-grid mb-4">
          <div class="spm-card bor">
            <i class="spm-icon bi bi-hospital" style="color: var(--primary);"></i>
          ...
          <div class="spm-card avlos">
            <i class="spm-icon bi bi-calendar-range" style="color: var(--success);"></i>
          ...
          <div class="spm-card bto">
            <i class="spm-icon bi bi-arrow-repeat" style="color: var(--warning);"></i>
          ...
          <div class="spm-card toi">
            <i class="spm-icon bi bi-hourglass-split" style="color: var(--purple);"></i>
          ...
          <div class="spm-card ndr">
            <i class="spm-icon bi bi-graph-down" style="color: var(--orange);"></i>
          ...
          <div class="d-flex justify-content-between align-items-start flex-wrap gap-2 mb-3">
            <div>
              <h6 class="fw-bold mb-1">
                <i class="bi bi-hospital" style="margin-right: 8px; color: var(--primary);"></i>Indikator SPM Per Ruang / Bangsal
              </h6>
              <div class="text-muted small fw-semibold">Detail BOR, AVLOS, BTO, dan TOI per unit perawatan</div>
            </div>
            <div class="legend">
              <div class="legend-item">
                <div class="legend-dot" style="background: #22c55e;"></div> Sesuai standar
              </div>
              <div class="legend-item">
                <div class="legend-dot" style="background: #f59e0b;"></div> Perlu perhatian
              </div>
              <div class="legend-item">
                <div class="legend-dot" style="background: #ef4444;"></div> Di luar standar
              </div>
            </div>
          </div>
          <div class="table-responsive">
            <table class="table table-hover align-middle" style="font-size: 13px;">
              <thead class="table-light">
                <tr>
                  ...
                  <th class="text-center">Hari Rawat</th>
                  <th class="text-center">BOR (%) <button type="button" class="info-btn"><i class="bi bi-question-circle"></i><div class="ttip">(Hari Rawat ÷ (TT × Hari)) × 100<br>Standar: 60–85%</div></button></th>
                  <th class="text-center">AVLOS (hr) <button type="button" class="info-btn"><i class="bi bi-question-circle"></i><div class="ttip">Σ LOS ÷ Σ Keluar<br>Standar: 6–9 hari</div></button></th>
                  <th class="text-center">BTO <button type="button" class="info-btn"><i class="bi bi-question-circle"></i><div class="ttip">Σ Keluar ÷ Σ TT<br>Standar: 40–50/tahun</div></button></th>
                  <th class="text-center">TOI (hr) <button type="button" class="info-btn"><i class="bi bi-question-circle"></i><div class="ttip">(TT × Hari − Hari Rawat) ÷ Σ Keluar<br>Standar: 1–3 hari</div></button></th>
        ...
        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
          <h6 class="fw-bold mb-1">
            <i class="bi bi-bar-chart" style="margin-right: 8px; color: var(--primary);"></i>Grafik BOR Per Ruang
          </h6>
        ...
        <div class="row g-4 mb-4">
          <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 p-4 h-100">
              <h6 class="fw-bold mb-3">
                <i class="bi bi-calendar" style="margin-right: 8px; color: var(--success);"></i>AVLOS Per Ruang (hari)
              </h6>
          ...
          <div class="col-md-6">
            <div class="card border-0 shadow-sm rounded-4 p-4 h-100">
              <h6 class="fw-bold mb-3">
                <i class="bi bi-arrow-repeat" style="margin-right: 8px; color: var(--purple);"></i>TOI Per Ruang (hari)
              </h6>
              <div class="chart-container">
    ...
    <script>
      ...
      function hitungSPM() {
        ...
        if (BOR !== null) {
          ...
          else if (BOR<60) setStatus("s-bor","status-warn","⚠ Di Bawah Standar");
        ...
        if (AVLOS !== null) {
          ...
          else if (AVLOS>0) setStatus("s-avlos","status-warn","⚠ Di Luar Standar");
        ...
        if (TOI !== null) {
          ...
          else if (TOI>3&&TOI<=5) setStatus("s-toi","status-warn","⚠ Perlu Perhatian");
        ...
        ruangList.forEach(ruang => {
          ...
          if (rBOR!==null) {
            ...
            else if ((rBOR>=50&&rBOR<60)||(rBOR>85&&rBOR<=95)) { badgeCls="badge-warn"; badgeTxt="⚠ Perhatian"; }
